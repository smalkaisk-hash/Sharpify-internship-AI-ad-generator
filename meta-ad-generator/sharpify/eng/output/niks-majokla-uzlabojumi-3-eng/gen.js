...
const IMG_BASE = 'file:///C:/Users/Ritvars%20Volfs/meta-ad-generator-v2/meta-ad-generator/sharpify/eng/output/niks-majokla-uzlabojumi-3-eng/images';

// ============================================================
// NICHES (ENG adaptation)
// ============================================================
const niches = [
  {
    slug: 'electricians',
    badge: 'For Electricians',
    archedH: 'You keep homes safe and wired.',
    archedEm: 'We keep the next job',
    archedH2: 'already booked.',
    stickerH1: 'New inquiries land <span class="accent">on their own</span>,',
    stickerH2: 'while you run the next&nbsp;cable.',
    notifBody: 'Electrical install<br>New York, NY',
    warnTrade: 'electrical',
    warnTradePerson: 'electrical contractors',
    warnTopLabel: 'Top 5% Electricians',
  },
  {
    slug: 'hvac',
    badge: 'For HVAC Installers',
    archedH: 'You keep homes warm for less.',
    archedEm: 'We keep the next install',
    archedH2: 'already booked.',
    stickerH1: 'New inquiries land <span class="accent">on their own</span>,',
    stickerH2: 'while you commission the next&nbsp;unit.',
    notifBody: 'Heat pump install<br>Austin, TX',
    warnTrade: 'HVAC',
    warnTradePerson: 'HVAC installers',
    warnTopLabel: 'Top 5% Installers',
  },
  {
    slug: 'flooring',
    badge: 'For Flooring Pros',
    archedH: 'You bring tired floors back to life.',
    archedEm: 'We keep the next room',
    archedH2: 'already booked.',
    stickerH1: 'New inquiries land <span class="accent">on their own</span>,',
    stickerH2: 'while you sand the next&nbsp;room.',
    notifBody: 'Hardwood refinishing<br>Chicago, IL',
    warnTrade: 'flooring',
    warnTradePerson: 'flooring pros',
    warnTopLabel: 'Top 5% Flooring Pros',
  },
];
...
h1{font-family:'Instrument Serif',serif;font-size:50px;line-height:1.12;color:#fff;letter-spacing:-0.02em;font-weight:400}
...
<div class="sub">AI ads, automated lead handling, and CRM — the full system that books your next job while you're on the current one.</div>
<div class="chips">
...
<div class="sub">Our MS Solution — targeted ads, automated lead handling, and CRM in one system.</div>
<div class="row">
...
.big{font-family:'Space Grotesk',sans-serif;font-weight:900;font-size:72px;color:#fff;line-height:0.95;letter-spacing:-0.02em;text-transform:uppercase;margin-bottom:52px;text-shadow:4px 4px 0 rgba(220,38,38,0.4),0 0 40px rgba(220,38,38,0.2)}
...
<div class="chip"><span class="dot"></span>Selection 2026<span class="dot"></span></div>
<div class="big">Run your own<br><span>${n.warnTrade}</span> company?</div>
<div class="frame">
<div class="frame-label">Apply → All Markets</div>
<div class="photo"><img src="${IMG_BASE}/${n.slug}.png"></div>
<div class="frame-corner">${n.warnTopLabel}</div>
</div>
<div class="sub">We're selecting <em>5 ${n.warnTradePerson}</em> ready to take on new clients every month with our AI marketing system.</div>
<div class="cta">Apply Now <span class="arr"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#DC2626" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></span></div>
<div class="proof"><b>2,300+ businesses</b> · already with Sharpify</div>
</div>
<div class="stripes"></div>
</div>
</body>
...
// ============================================================
// Render: 3 niches × 3 templates = 9 HTMLs (matching LV set)
// ============================================================
