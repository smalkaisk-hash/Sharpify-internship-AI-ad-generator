...
const SceneHook: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ opacity: outOpacity }}>
      {/* Background video — real excavator demolition, pattern interrupt */}
      <AbsoluteFill style={{ transform: `scale(${zoom})` }}>
        <OffthreadVideo
          src={staticFile("videos/construction-lv/hook-demolition-b.mp4")}
          muted
          trimBefore={30}
...
export const SharpifyConstructionLV: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: BLACK }}>
