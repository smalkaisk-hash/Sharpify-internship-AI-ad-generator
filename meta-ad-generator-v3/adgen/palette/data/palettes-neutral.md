...
| industrial safety, B2B, construction, heavy industry | B2B / Industrial / Professional Services |
...
**Theme:** Light — **Use for:** industrial safety, B2B, construction, heavy industry, professional services

| Swatch | Hex | Luminance |
|---|---|---|
| Lightest | `#F0F2F5` | L≈0.89 |
| Light Mid | `#C8D4E0` | L≈0.68 |
| Mid | `#8A9AA8` | L≈0.33 |
| Dark Mid | `#E8750A` | L≈0.23 |
| Darkest | `#1A2535` | L≈0.02 |

| Role | Value |
|---|---|
| Base | `#F0F2F5` |
| Second tone (decorative only) | `#C8D4E0` |
| Accent (decorative only) | `#8A9AA8` |
| Accent (decorative only) | `#E8750A` |
| **Text + CTA button** | `#1A2535` |
| **Body text hex** | `#1A2535` (18.8:1 on base ✓) |
| **CTA text** | `#F0F2F5` (18.8:1 on `#1A2535` ✓) |
| Accent glow | `rgba(232,117,10,0.26)` |
| Atmosphere | `rgba(200,212,224,0.10)` |
---

## Botanical Water

**Theme:** Light — **Use for:** natural skincare, botanical beauty, water purification, clean living, organic lifestyle

| Swatch | Hex | Luminance |
|---|---|---|
| Lightest | `#EBF6F0` | L≈0.88 |
| Light Mid | `#C8E8F5` | L≈0.79 |
| Mid | `#4BADD6` | L≈0.25 |
| Dark Mid | `#5A9E6B` | L≈0.28 |
| Darkest | `#1A3D2E` | L≈0.03 |

| Role | Value |
|---|---|
| Base | `#EBF6F0` |
| Second tone (decorative only) | `#C8E8F5` |
| Accent (decorative only) | `#4BADD6` |
| Accent (decorative only) | `#5A9E6B` |
| **Text + CTA button** | `#1A3D2E` |
| **Body text hex** | `#1A3D2E` (17.2:1 on base ✓) |
| **CTA text** | `#EBF6F0` (17.2:1 on `#1A3D2E` ✓) |
| Accent glow | `rgba(75,173,214,0.26)` |
| Atmosphere | `rgba(200,232,245,0.10)` |
---

## Warm Chocolate

**Theme:** Dark — **Use for:** warm lifestyle photography, natural beauty, skincare, wellness, portrait-heavy brands

| Swatch | Hex | Luminance |
|---|---|---|
| Lightest | `#F4E0CC` | L≈0.77 |
| Light Mid | `#E8C9A8` | L≈0.58 |
| Mid | `#DC9C5F` | L≈0.34 |
| Dark Mid | `#A86840` | L≈0.13 |
| Darkest | `#452016` | L≈0.02 |

| Role | Value |
|---|---|
| Base | `#F4E0CC` |
| Second tone (decorative only) | `#E8C9A8` |
| Accent (decorative only) | `#DC9C5F` |
| Accent (decorative only) | `#A86840` |
| **Text + CTA button** | `#452016` |
| **Body text hex** | `#452016` (11.2:1 on base ✓) |
| **CTA text** | `#F4E0CC` (11.2:1 on `#452016` ✓) |
| Accent glow | `rgba(220,156,95,0.26)` |
| Atmosphere | `rgba(232,201,168,0.10)` |
---

## Slate Teal

**Theme:** Light — **Use for:** clean beauty, product photography, water/purity brands, mixed warm/cool tones

| Swatch | Hex | Luminance |
|---|---|---|
| Lightest | `#F8F7F4` | L≈0.95 |
| Light Mid | `#C8D8DC` | L≈0.71 |
| Mid | `#75B2C6` | L≈0.42 |
| Dark Mid | `#C09F72` | L≈0.37 |
| Darkest | `#1C2E35` | L≈0.02 |

| Role | Value |
|---|---|
| Base | `#F8F7F4` |
| Second tone (decorative only) | `#C8D8DC` |
| Accent (decorative only) | `#75B2C6` |
| Accent (decorative only) | `#C09F72` |
| **Text + CTA button** | `#1C2E35` |
| **Body text hex** | `#1C2E35` (13.2:1 on base ✓) |
| **CTA text** | `#F8F7F4` (13.2:1 on `#1C2E35` ✓) |
| Accent glow | `rgba(117,178,198,0.26)` |
| Atmosphere | `rgba(200,216,220,0.10)` |
---
